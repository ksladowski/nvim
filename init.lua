...
--                 "--razorSourceGenerator=" .. vim.fs.joinpath(razor, "Microsoft.CodeAnalysis.Razor.Compiler.dll"),
--                 "--razorDesignTimePath="
--                     .. vim.fs.joinpath(razor, "Targets", "Microsoft.NET.Sdk.Razor.DesignTime.targets"),
--                 "--extension",
