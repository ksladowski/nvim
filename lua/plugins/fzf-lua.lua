...
nnoremap("<leader>f", FzfLua.files, { desc = "Find file in working directory" })
nnoremap("<leader>F", function()
    FzfLua.files({ cwd = vim.fn.expand("%:p:h") })
end, { desc = "Find file in current file's dir" })

nnoremap("<leader>s", FzfLua.live_grep, { desc = "Search text in working dir" })
nnoremap("<leader>S", function()
    FzfLua.live_grep({ cwd = vim.fn.expand("%:p:h") })
end, { desc = "Search text in current file's dir" })
